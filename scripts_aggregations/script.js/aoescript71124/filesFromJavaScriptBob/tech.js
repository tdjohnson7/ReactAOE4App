const data = [
  {
    ...
    type: 'technology',
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Mining Technology 2/3'],
    classes: ['mining', 'technology', '2/3'],
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/acid-distillation-3.png',
    description:
  ...
  },
  {
    ...
    type: 'technology',
    civs: ['ab', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Mangonel Technology'],
    classes: ['mangonel', 'technology'],
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/adjustable-crossbars-4.png',
    description: 'Reduce the reload time of Mangonels by -25%.',
    variations: [
      {
  ...
  },
  {
    ...
    civs: ['en'],
    unique: true,
    displayClasses: ['Naval Technology'],
    classes: ['naval', 'technology'],
    minAge: 2,
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Ranged Armor Technology 3/3'],
    classes: ['ranged', 'armor', 'technology', '3/3'],
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/angled-surfaces-4.png',
    ...
    variations: [
      ...
      },
      {
        ...
        attribName: 'upgrade_ranged_armor_iii',
        civs: ['hr'],
        producedBy: ['meinwerk-palace', 'blacksmith'],
      },
      {
        id: 'angled-surfaces-4',
        pbgid: 188268,
  ...
  },
  {
    ...
    civs: ['en'],
    unique: true,
    displayClasses: ['Man-at-Arms Technology'],
    classes: ['man-at-arms', 'technology'],
    minAge: 3,
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Naval Technology 1/2'],
    classes: ['naval', 'technology', '1/2'],
    minAge: 3,
  ...
  },
  {
    ...
    civs: ['en'],
    unique: true,
    displayClasses: ['Longbowman Ability Unlock'],
    classes: ['longbowman', 'ability', 'unlock'],
    minAge: 4,
    ...
    variations: [
      {
        ...
        producedBy: ['council-hall', 'archery-range'],
        icon:
          'https://data.aoe4world.com/images/technologies/arrow-volley-4.png',
        effects: [
          {
            property: 'attackSpeed',
            select: {
  ...
  },
  {
    ...
    civs: ['ab', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Weapon Emplacement'],
    classes: ['weapon', 'emplacement'],
    minAge: 2,
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Ranged Damage Technology 2/3'],
    classes: ['ranged', 'damage', 'technology', '2/3'],
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/balanced-projectiles-3.png',
    description:
  ...
  },
  {
    ...
    name: 'Biology',
    type: 'technology',
    civs: ['ab', 'ch', 'de', 'en', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Cavalry Technology'],
    classes: ['cavalry', 'technology'],
    minAge: 4,
    ...
    variations: [
      ...
      },
      {
        ...
        producedBy: ['hisar-academy', 'madrasa'],
      },
      {
        id: 'biology-4',
        pbgid: 127850,
      ...
      },
      {
        ...
        attribName: 'upgrade_tech_university_biology',
        civs: ['ot'],
        producedBy: ['istanbul-observatory', 'university'],
      },
      {
        id: 'biology-4',
        pbgid: 127850,
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Melee Damage Technology 1/3'],
    classes: ['melee', 'damage', 'technology', '1/3'],
    minAge: 2,
  ...
  },
  {
    ...
    name: 'Boiling Oil',
    type: 'technology',
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Defensive Technology'],
    classes: ['defensive', 'technology'],
    minAge: 3,
    ...
    variations: [
      {
        ...
        civs: ['en'],
        producedBy: ['the-white-tower', 'keep', 'berkshire-palace'],
      },
      {
        id: 'boiling-oil-3',
        pbgid: 128447,
        attribName: 'upgrade_tech_university_murder_holes_4',
        civs: ['hr'],
        producedBy: ['keep', 'elzbach-palace'],
      },
      {
        id: 'boiling-oil-3',
        pbgid: 128447,
      ...
      },
      {
        ...
        producedBy: ['compound-of-the-defender', 'keep'],
      },
      {
        id: 'boiling-oil-3',
        pbgid: 128447,
      ...
      },
      {
        ...
        attribName: 'upgrade_tech_university_murder_holes_4',
        civs: ['ma'],
        producedBy: ['keep', 'fort-of-the-huntress'],
      },
      {
        id: 'boiling-oil-3',
        pbgid: 128447,
        attribName: 'upgrade_tech_university_murder_holes_4',
        civs: ['ot'],
        producedBy: ['keep', 'sea-gate-castle'],
      },
      {
        id: 'boiling-oil-3',
        pbgid: 128447,
        attribName: 'upgrade_tech_university_murder_holes_4',
        civs: ['ru'],
        producedBy: ['keep', 'spasskaya-tower'],
      },
    ],
    baseId: 'boiling-oil',
    age: 3,
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/cannon-emplacement-4.png',
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Gunpowder Technology'],
    classes: ['gunpowder', 'technology'],
    minAge: 4,
    ...
    variations: [
      ...
      },
      {
        ...
        attribName: 'upgrade_siege_chemistry',
        civs: ['fr'],
        producedBy: ['college-of-artillery', 'university'],
      },
      {
        id: 'chemistry-4',
        pbgid: 124734,
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Building Technology'],
    classes: ['building', 'technology'],
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/court-architects-3.png',
    ...
    producedBy: ['compound-of-the-defender'],
    effects: [
      {
        property: 'hitpoints',
        select: {
          class: [['building'], ['landmark'], ['wonder']],
        },
        effect: 'multiply',
        value: 1.3,
        type: 'passive',
    ...
    shared: {
      'court-architects-4': {
        ...
        producedBy: ['university'],
        icon:
          'https://data.aoe4world.com/images/technologies/court-architects-4.png',
        id: 'court-architects-4',
      },
    },
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Wood Gathering Technology 3/3'],
    classes: ['wood', 'gathering', 'technology', '3/3'],
    minAge: 4,
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Mining Technology 3/3'],
    classes: ['mining', 'technology', '3/3'],
    minAge: 4,
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Melee Damage Technology 3/3'],
    classes: ['melee', 'damage', 'technology', '3/3'],
    minAge: 4,
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Melee Damage Technology 2/3'],
    classes: ['melee', 'damage', 'technology', '2/3'],
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/decarbonization-3.png',
    description: 'Increase the melee damage of all non-siege units by +1.',
    variations: [
      {
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Wood Gathering Technology 1/3'],
    classes: ['wood', 'gathering', 'technology', '1/3'],
    minAge: 2,
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Fishing Technology 2/2'],
    classes: ['fishing', 'technology', '2/2'],
    minAge: 3,
    ...
    effects: [
      {
        ...
        select: {
          id: ['fishing-boat', 'lodya-fishing-boat'],
        },
        effect: 'multiply',
        value: 1.15,
        type: 'passive',
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Melee Infantry Technology'],
    classes: ['melee', 'infantry', 'technology'],
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/elite-army-tactics-4.png',
    description:
  ...
  },
  {
    ...
    civs: ['en'],
    unique: true,
    displayClasses: ['Farm Technology'],
    classes: ['farm', 'technology'],
    minAge: 4,
    icon: 'https://data.aoe4world.com/images/technologies/enclosures-4.png',
    description:
      'Each Farm Enclosure being worked by a Villager generates +1 Gold every 5 seconds.',
    variations: [
      {
        id: 'enclosures-4',
        baseId: 'enclosures',
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Fishing Technology 1/2'],
    classes: ['fishing', 'technology', '1/2'],
    minAge: 2,
    icon: 'https://data.aoe4world.com/images/technologies/extended-lines-2.png',
    description:
      'Increase the gathering rate of Fishing Ships by +20% and carry capacity by +10.',
    variations: [
      {
        id: 'extended-lines-2',
        pbgid: 2033745,
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Food Gathering Technology 2/3'],
    classes: ['food', 'gathering', 'technology', '2/3'],
    minAge: 3,
    icon: 'https://data.aoe4world.com/images/technologies/fertilization-3.png',
    description:
      "Increase Villagers' gathering rate for Food by 15%. Does not apply to hunted meat.",
    variations: [
      {
        id: 'fertilization-3',
        pbgid: 171292,
      ...
      },
      {
        ...
        attribName: 'upgrade_econ_resource_food_harvest_rate_3',
        civs: ['ot'],
        producedBy: ['mill', 'twin-minaret-medrese'],
      },
      {
        id: 'fertilization-3',
        pbgid: 171292,
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Melee Armor Technology 1/3'],
    classes: ['melee', 'armor', 'technology', '1/3'],
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/fitted-leatherwork-2.png',
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Woodcutting Technology'],
    classes: ['woodcutting', 'technology'],
    minAge: 1,
  ...
  },
  {
    ...
    type: 'technology',
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'ot'],
    unique: false,
    displayClasses: ['Defensive Emplacement'],
    classes: ['defensive', 'emplacement'],
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/fortify-outpost-2.png',
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Trebuchet Technology'],
    classes: ['trebuchet', 'technology'],
    minAge: 4,
    ...
    variations: [
      ...
      },
      {
        ...
        attribName: 'upgrade_siege_mathematics',
        civs: ['ch'],
        producedBy: ['astronomical-clocktower', 'siege-workshop'],
      },
      {
        id: 'geometry-4',
        pbgid: 182082,
    ...
    effects: [
      {
        property: 'siegeAttack',
        select: {
          id: ['huihui-pao', 'counterweight-trebuchet', 'traction-trebuchet'],
        },
        effect: 'multiply',
        value: 1.2,
        type: 'passive',
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Siege Technology'],
    classes: ['siege', 'technology'],
    minAge: 3,
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Healing Technology'],
    classes: ['healing', 'technology'],
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/herbal-medicine-3.png',
    ...
    variations: [
      ...
      },
      {
        ...
        producedBy: ['regnitz-cathedral', 'monastery'],
      },
      {
        id: 'herbal-medicine-3',
        pbgid: 129401,
      ...
      },
      {
        ...
        producedBy: ['mosque', 'dome-of-the-faith'],
      },
      {
        id: 'herbal-medicine-3',
        pbgid: 129401,
      ...
      },
      {
        ...
        attribName: 'upgrade_unit_religious_herbal_medicine_4',
        civs: ['ru'],
        producedBy: ['abbey-of-the-trinity', 'monastery'],
      },
    ],
    ...
    effects: [
      {
        ...
        select: {
          id: ['prelate', 'monk', 'scholar', 'shaman', 'imam', 'warrior-monk'],
        },
        effect: 'multiply',
        value: 1.6,
        type: 'passive',
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Food Gathering Technology 1/3'],
    classes: ['food', 'gathering', 'technology', '1/3'],
    minAge: 2,
  ...
  },
  {
    ...
    type: 'technology',
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Ranged Technology'],
    classes: ['ranged', 'technology'],
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/incendiary-arrows-4.png',
    description:
      'Increase the damage of ranged units by +20%. Does not apply to gunpowder units.',
    variations: [
      {
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Melee Armor Technology 2/3'],
    classes: ['melee', 'armor', 'technology', '2/3'],
    minAge: 3,
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Ranged Armor Technology 1/3'],
    classes: ['ranged', 'armor', 'technology', '1/3'],
    minAge: 2,
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Battering Ram Technology'],
    classes: ['battering', 'ram', 'technology'],
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/lightweight-beams-4.png',
    description:
    ...
    effects: [
      {
        property: 'attackSpeed',
        select: {
          id: ['battering-ram', 'clocktower-battering-ram'],
        },
        effect: 'change',
        value: -1.3612499999999998,
        type: 'passive',
      },
      {
        property: 'buildTime',
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Wood Gathering Technology 2/3'],
    classes: ['wood', 'gathering', 'technology', '2/3'],
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/lumber-preservation-3.png',
    description: "Increase Villagers' gathering rate for Wood by 15%.",
    variations: [
      {
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Melee Armor Technology 3/3'],
    classes: ['melee', 'armor', 'technology', '3/3'],
    minAge: 4,
  ...
  },
  {
    ...
    type: 'technology',
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ru'],
    unique: false,
    displayClasses: ['Production Technology'],
    classes: ['production', 'technology'],
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/military-academy-3.png',
    description:
  ...
  },
  {
    ...
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/naval-arrowslits-2.png',
    description:
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/network-of-citadels-3.png',
    description:
      'Increase the Network of Castles attack speed bonus from +15% to +40%.',
    variations: [
      {
        ...
        effects: [
          {
            ...
            target: {
              class: [['infantry'], ['cavalry'], ['building']],
            },
            effect: 'multiply',
            value: 1.4,
            type: 'bonus',
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Religious Technology'],
    classes: ['religious', 'technology'],
    minAge: 4,
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Ranged Damage Technology 3/3'],
    classes: ['ranged', 'damage', 'technology', '3/3'],
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/platecutter-point-4.png',
    description:
      'Increase the ranged damage of all non-siege units and buildings by +1.',
    variations: [
      {
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Food Gathering Technology 3/3'],
    classes: ['food', 'gathering', 'technology', '3/3'],
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/precision-cross-breeding-4.png',
    description:
      "Increase Villagers' gathering rate for Food by 15%. Does not apply to hunted meat.",
    variations: [
      {
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Hunting Technology'],
    classes: ['hunting', 'technology'],
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/professional-scouts-2.png',
    description:
      'Scouts gain the ability to carry animal carcasses and +100% damage against wild animals.\nScouts move -35% slower while carrying and cannot pick up Boar.',
    variations: [
      {
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Springald Technology'],
    classes: ['springald', 'technology'],
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/roller-shutter-triggers-4.png',
    description:
  ...
  },
  {
    ...
    classes: ['longbowman', 'ability', 'unlock'],
    minAge: 2,
    icon: 'https://data.aoe4world.com/images/technologies/setup-camp-2.png',
    description:
    ...
    variations: [
      {
        ...
        name: 'Setup Camp',
        pbgid: 202553,
        attribName: 'upgrade_longbow_make_camp_eng',
        age: 2,
        civs: ['en'],
        description:
          'Longbowmen gain the ability to Setup Camp, which heals them for +1 health every 1 seconds.',
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/shattering-projectiles-4.png',
    description:
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Naval Technology 2/2'],
    classes: ['naval', 'technology', '2/2'],
    minAge: 4,
  ...
  },
  {
    ...
    type: 'technology',
    civs: ['ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Siege Unit Unlock'],
    classes: ['siege', 'unit', 'unlock'],
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/siege-engineering-2.png',
    description:
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Mining Technology 1/3'],
    classes: ['mining', 'technology', '1/3'],
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/specialized-pick-2.png',
    description:
      "Increase Villagers' gathering rate for Gold and Stone by 15%.",
    variations: [
      {
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/springald-crews-3.png',
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/springald-emplacement-3.png',
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Ranged Damage Technology 1/3'],
    classes: ['ranged', 'damage', 'technology', '1/3'],
    minAge: 2,
  ...
  },
  {
    ...
    minAge: 1,
    icon:
      'https://data.aoe4world.com/images/technologies/survival-techniques-1.png',
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Villager Technology'],
    classes: ['villager', 'technology'],
    minAge: 2,
    icon: 'https://data.aoe4world.com/images/technologies/textiles-2.png',
    description: "Increase Villagers' health by +25.",
    variations: [
      {
        id: 'textiles-2',
        pbgid: 2045367,
        ...
        civs: ['en'],
        producedBy: ['capital-town-center', 'town-center', 'kings-palace'],
      },
      {
        id: 'textiles-2',
        pbgid: 2045367,
        attribName: 'upgrade_villager_health',
        civs: ['hr'],
        producedBy: ['capital-town-center', 'town-center', 'palace-of-swabia'],
      },
      {
        id: 'textiles-2',
        pbgid: 2045367,
      ...
      },
      {
        ...
        attribName: 'upgrade_villager_health',
        civs: ['mo'],
        producedBy: ['town-center', 'capital-town-center'],
      },
      {
        id: 'textiles-2',
        pbgid: 2045367,
    ...
    producedBy: ['capital-town-center', 'town-center'],
    effects: [
      {
        property: 'hitpoints',
        select: {
  ...
  },
  {
    ...
    description:
      'Relics placed in a Monastery provide an income of +30 Food, +30 Wood, and +30 Stone every minute.',
    variations: [
      {
        id: 'tithe-barns-4',
        pbgid: 129407,
      ...
      },
      {
        ...
        civs: ['hr'],
        description:
          'Relics placed in eligible buildings provide an income of +30 Food, +30 Wood, and +30 Stone every minute.',
        producedBy: ['regnitz-cathedral', 'monastery'],
      },
      {
        id: 'tithe-barns-4',
      ...
      },
      {
        ...
        civs: ['de'],
        description:
          'Relics placed in a Mosque provide an income of +30 Food, +30 Wood, and +30 Stone every minute.',
        costs: {
          food: 0,
          wood: 0,
          stone: 0,
      ...
      },
      {
        ...
        civs: ['mo'],
        description:
          'Relics placed in a Prayer Tent provide an income of +30 Food, +30 Wood, and +30 Stone every minute.',
        producedBy: ['prayer-tent'],
      },
      {
        id: 'tithe-barns-4',
    ...
    effects: [
      {
        property: 'unknown',
        select: {
          id: ['monastery', 'mosque', 'prayer-tent', 'regnitz-cathedral'],
        },
        effect: 'change',
        value: 30,
        type: 'influence',
  ...
  },
  {
    ...
    civs: ['ab', 'ch', 'de', 'en', 'fr', 'hr', 'ma', 'mo', 'ot', 'ru'],
    unique: false,
    displayClasses: ['Ranged Armor Technology 2/3'],
    classes: ['ranged', 'armor', 'technology', '2/3'],
    minAge: 3,
  ...
  },
  {
    ...
    civs: ['hr'],
    unique: true,
    displayClasses: ['Construction Technology'],
    classes: ['construction', 'technology'],
    minAge: 3,
    icon: 'https://data.aoe4world.com/images/technologies/benediction-3.png',
    description: 'Inspired Villagers construct +15% faster.',
    variations: [
      {
        id: 'benediction-3',
        baseId: 'benediction',
        ...
        name: 'Benediction',
        pbgid: 180214,
        attribName: 'upgrade_benediction_hre',
        age: 3,
        civs: ['hr'],
        description: 'Inspired Villagers construct +15% faster.',
        classes: ['construction', 'technology'],
        ...
        producedBy: ['regnitz-cathedral', 'monastery'],
        icon:
          'https://data.aoe4world.com/images/technologies/benediction-3.png',
        effects: [
          {
            property: 'buildTime',
            select: {
  ...
  },
  {
    ...
    civs: ['hr'],
    unique: true,
    displayClasses: ['Gathering Technology'],
    classes: ['gathering', 'technology'],
    minAge: 3,
    icon: 'https://data.aoe4world.com/images/technologies/devoutness-3.png',
    description: 'Inspired Villagers gather resources +10% faster.',
    variations: [
      {
        id: 'devoutness-3',
        baseId: 'devoutness',
    ...
    variations: [
      {
        ...
        producedBy: ['dock'],
        icon:
          'https://data.aoe4world.com/images/technologies/fire-stations-2.png',
        effects: [
          {
            property: 'healingRate',
            select: {
    ...
    variations: [
      {
        ...
        icon:
          'https://data.aoe4world.com/images/technologies/heavy-maces-3.png',
        effects: [
          {
            property: 'meleeAttack',
            select: {
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/inspired-warriors-3.png',
    description:
  ...
  },
  {
    ...
    civs: ['hr'],
    unique: true,
    displayClasses: ['Infantry Technology'],
    classes: ['infantry', 'technology'],
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/marching-drills-2.png',
    description:
      'Increase the movement speed of infantry and religious units by +10%.',
    variations: [
      {
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/reinforced-defenses-4.png',
  ...
  },
  {
    ...
    civs: ['hr'],
    unique: true,
    displayClasses: ['Spearman and Horseman Technology'],
    classes: ['spearman', 'and', 'horseman', 'technology'],
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/riveted-chain-mail-2.png',
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/slate-and-stone-construction-3.png',
    ...
    variations: [
      {
        ...
        producedBy: ['meinwerk-palace'],
        icon:
          'https://data.aoe4world.com/images/technologies/steel-barding-3.png',
        effects: [
          {
            property: 'meleeArmor',
            select: {
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/two-handed-weapons-3.png',
    description:
  ...
  },
  {
    ...
    civs: ['fr'],
    unique: true,
    displayClasses: ['Royal Knight Technology'],
    classes: ['royal', 'knight', 'technology'],
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/cantled-saddles-3.png',
    description:
  ...
  },
  {
    ...
    civs: ['fr'],
    unique: true,
    displayClasses: ['Arbalétrier Technology'],
    classes: ['arbalétrier', 'technology'],
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/crossbow-stirrups-3.png',
    description: 'Reduce the reload time of Arbalétriers by -25%.',
    variations: [
      {
    ...
    shared: {
      'crossbow-stirrups-4': {
        ...
        icon:
          'https://data.aoe4world.com/images/technologies/crossbow-stirrups-4.png',
        id: 'crossbow-stirrups-4',
      },
    },
  },
  {
    ...
    civs: ['fr'],
    unique: true,
    displayClasses: ['Influence Technology'],
    classes: ['influence', 'technology'],
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/enlistment-incentives-3.png',
    description:
    ...
    shared: {
      'enlistment-incentives-4': {
        ...
        producedBy: ['keep', 'red-palace'],
        icon:
          'https://data.aoe4world.com/images/technologies/enlistment-incentives-4.png',
        id: 'enlistment-incentives-4',
      },
    },
  },
  ...
  },
  {
    ...
    classes: ['naval', 'technology'],
    minAge: 3,
    icon: 'https://data.aoe4world.com/images/technologies/long-guns-3.png',
    description: 'Increase the damage of naval cannons by +10%.',
    variations: [
      {
        id: 'long-guns-3',
        baseId: 'long-guns',
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/royal-bloodlines-3.png',
    ...
    shared: {
      'royal-bloodlines-4': {
        ...
        producedBy: ['university'],
        icon:
          'https://data.aoe4world.com/images/technologies/royal-bloodlines-4.png',
        id: 'royal-bloodlines-4',
      },
    },
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/ancient-techniques-4.png',
    description:
    ...
    variations: [
      {
        ...
        producedBy: ['spirit-way', 'university'],
        icon:
          'https://data.aoe4world.com/images/technologies/ancient-techniques-4.png',
        effects: [
          {
  ...
  },
  {
    ...
    civs: ['ch'],
    unique: true,
    displayClasses: ['Palace Guard Technology'],
    classes: ['palace', 'guard', 'technology'],
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/battle-hardened-4.png',
  ...
  },
  {
    ...
    civs: ['ch'],
    unique: true,
    displayClasses: ['Tower & Outpost Technology'],
    classes: ['tower', '&', 'outpost', 'technology'],
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/extra-materials-3.png',
    description:
  ...
  },
  {
    ...
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/handcannon-slits-2.png',
    description:
  ...
  },
  {
    ...
    civs: ['ch'],
    unique: true,
    displayClasses: ['Imperial Official Technology'],
    classes: ['imperial', 'official', 'technology'],
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/imperial-examinations-2.png',
    description:
    ...
    variations: [
      {
        ...
        producedBy: ['archery-range'],
        icon:
          'https://data.aoe4world.com/images/technologies/pyrotechnics-4.png',
        effects: [
          {
            property: 'maxRange',
            select: {
  ...
  },
  {
    ...
    civs: ['ch'],
    unique: true,
    displayClasses: ['Bombard Technology'],
    classes: ['bombard', 'technology'],
    minAge: 4,
    icon: 'https://data.aoe4world.com/images/technologies/reload-drills-4.png',
    description: 'Increase attack speed of Bombards by -33%.',
    variations: [
      {
        id: 'reload-drills-4',
        ...
        producedBy: ['astronomical-clocktower', 'siege-workshop'],
        icon:
          'https://data.aoe4world.com/images/technologies/reload-drills-4.png',
        effects: [
          {
            property: 'attackSpeed',
            select: {
  ...
  },
  {
    ...
    civs: ['ch'],
    unique: true,
    displayClasses: ['Nest of Bees Technology'],
    classes: ['nest', 'of', 'bees', 'technology'],
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/reusable-barrels-4.png',
    description: 'Reduce the cost of Nest of Bees by -25%.',
    variations: [
      {
        id: 'reusable-barrels-4',
        baseId: 'reusable-barrels',
        type: 'technology',
        name: 'Reusable Barrels',
        pbgid: 217078,
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/thunderclap-bombs-4.png',
    ...
    variations: [
      {
        ...
        producedBy: ['mosque', 'dome-of-the-faith'],
        icon:
          'https://data.aoe4world.com/images/technologies/all-seeing-eye-2.png',
        effects: [
          {
  ...
  },
  {
    ...
    civs: ['de'],
    unique: true,
    displayClasses: ['Elephant Technology'],
    classes: ['elephant', 'technology'],
    minAge: 4,
    ...
    variations: [
      {
        ...
        producedBy: ['stable'],
        icon:
          'https://data.aoe4world.com/images/technologies/armored-beasts-4.png',
        effects: [
          {
            property: 'rangedArmor',
            select: {
  ...
  },
  {
    ...
    minAge: 1,
    icon:
      'https://data.aoe4world.com/images/technologies/efficient-production-1.png',
    description:
  ...
  },
  {
    ...
    civs: ['de'],
    unique: true,
    displayClasses: ['Infantry Ability Unlock'],
    classes: ['infantry', 'ability', 'unlock'],
    minAge: 3,
    ...
    variations: [
      {
        ...
        producedBy: ['blacksmith'],
        icon:
          'https://data.aoe4world.com/images/technologies/forced-march-3.png',
        effects: [
          {
            property: 'moveSpeed',
            select: {
  ...
  },
  {
    ...
    description: 'Increase the carrying capacity of Villagers by +5.',
    variations: [
      {
        id: 'hearty-rations-3',
        ...
        producedBy: ['house-of-learning'],
        icon:
          'https://data.aoe4world.com/images/technologies/hearty-rations-3.png',
        effects: [
          {
            property: 'carryCapacity',
            select: {
  ...
  },
  {
    ...
    civs: ['de'],
    unique: true,
    displayClasses: ['Man-at-Arms & Lancer Technology'],
    classes: ['man-at-arms', '&', 'lancer', 'technology'],
    minAge: 3,
    ...
    variations: [
      {
        ...
        producedBy: ['house-of-learning'],
        icon:
          'https://data.aoe4world.com/images/technologies/honed-blades-3.png',
        effects: [
          {
            property: 'meleeAttack',
            select: {
              id: ['man-at-arms', 'knight', 'lancer'],
            },
            effect: 'change',
            value: 3,
            type: 'passive',
    ...
    variations: [
      {
        ...
        effects: [
          ...
          },
          {
            property: 'rangedArmor',
            select: {
              id: ['tower-elephant', 'sultans-elite-tower-elephant'],
            },
            effect: 'change',
            value: 4,
            type: 'passive',
  ...
  },
  {
    ...
    civs: ['de'],
    unique: true,
    displayClasses: ['Outpost Technology'],
    classes: ['outpost', 'technology'],
    minAge: 3,
    ...
    variations: [
      {
        ...
        producedBy: ['house-of-learning'],
        icon:
          'https://data.aoe4world.com/images/technologies/lookout-towers-3.png',
        effects: [
          {
            property: 'lineOfSight',
            select: {
  ...
  },
  {
    ...
    minAge: 1,
    icon:
      'https://data.aoe4world.com/images/technologies/manuscript-trade-1.png',
    description:
      'Scholars garrisoned in Docks provide +30% faster production speed and contribute to global research.',
    variations: [
      {
  ...
  },
  {
    ...
    civs: ['de'],
    unique: true,
    displayClasses: ['Population Technology'],
    classes: ['population', 'technology'],
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/reinforced-foundations-3.png',
    description:
  ...
  },
  {
    ...
    description:
      'Allow Scholars to capture Sacred Sites before the Castle Age (III). Sacred Sites generate +50% more Gold.',
    variations: [
      {
        id: 'sanctity-2',
        baseId: 'sanctity',
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/slow-burning-defenses-3.png',
    description:
    ...
    effects: [
      {
        property: 'fireArmor',
        select: {
          id: ['stone-wall-tower', 'keep', 'outpost'],
        },
        effect: 'change',
        value: 10,
        type: 'passive',
    ...
    shared: {
      'slow-burning-defenses-4': {
        ...
        producedBy: ['keep'],
        icon:
          'https://data.aoe4world.com/images/technologies/slow-burning-defenses-4.png',
        id: 'slow-burning-defenses-4',
      },
    },
  },
  ...
  },
  {
    ...
    civs: ['de'],
    unique: true,
    displayClasses: ['Mosque Technology'],
    classes: ['mosque', 'technology'],
    minAge: 3,
    icon: 'https://data.aoe4world.com/images/technologies/tranquil-venue-3.png',
    description:
      'Mosques restore +2 health every second to units that are out of combat.',
    variations: [
      {
        id: 'tranquil-venue-3',
        ...
        producedBy: ['house-of-learning'],
        icon:
          'https://data.aoe4world.com/images/technologies/tranquil-venue-3.png',
        effects: [
          {
            property: 'healingRate',
            select: {
  ...
  },
  {
    ...
    civs: ['de'],
    unique: true,
    displayClasses: ['Keep Technology'],
    classes: ['keep', 'technology'],
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/village-fortresses-3.png',
    description:
    ...
    variations: [
      {
        ...
        producedBy: ['house-of-wisdom'],
        icon:
          'https://data.aoe4world.com/images/technologies/agriculture-3.png',
        effects: [
          {
            property: 'foodGatherRate',
            select: {
  ...
  },
  {
    ...
    civs: ['ab'],
    unique: true,
    displayClasses: ['Trade Technology'],
    classes: ['trade', 'technology'],
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/armored-caravans-3.png',
  ...
  },
  {
    ...
    civs: ['ab'],
    unique: true,
    displayClasses: ['Camel Technology'],
    classes: ['camel', 'technology'],
    minAge: 3,
    ...
    variations: [
      {
        ...
        producedBy: ['blacksmith'],
        icon:
          'https://data.aoe4world.com/images/technologies/camel-handling-3.png',
        effects: [
          {
            property: 'moveSpeed',
            select: {
              id: ['camel-rider', 'camel-archer'],
            },
            effect: 'multiply',
            value: 1.15,
            type: 'passive',
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/camel-rider-barding-4.png',
  ...
  },
  {
    ...
    civs: ['ab'],
    unique: true,
    displayClasses: ['Camel Rider Technology'],
    classes: ['camel', 'rider', 'technology'],
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/camel-rider-shields-3.png',
    description:
    ...
    variations: [
      {
        ...
        producedBy: ['house-of-wisdom'],
        icon:
          'https://data.aoe4world.com/images/technologies/camel-support-4.png',
        effects: [
          {
            property: 'meleeArmor',
            select: {
  ...
  },
  {
    ...
    civs: ['ab'],
    unique: true,
    displayClasses: ['Archer Technology'],
    classes: ['archer', 'technology'],
    minAge: 3,
    icon: 'https://data.aoe4world.com/images/technologies/composite-bows-3.png',
    description: 'Reduce the reload time of Archers by -33%.',
    variations: [
      {
        id: 'composite-bows-3',
        ...
        producedBy: ['house-of-wisdom'],
        icon:
          'https://data.aoe4world.com/images/technologies/composite-bows-3.png',
        effects: [
          {
            property: 'attackSpeed',
            select: {
  ...
  },
  {
    ...
    civs: ['ab'],
    unique: false,
    displayClasses: ['Advance to Age II'],
    classes: ['advance', 'to', 'age', 'ii'],
    minAge: 1,
    ...
    variations: [
      {
        ...
        producedBy: ['house-of-wisdom'],
        icon:
          'https://data.aoe4world.com/images/technologies/culture-wing-1.png',
        effects: [
          {
            property: 'hitpoints',
            select: {
    ...
    variations: [
      {
        ...
        producedBy: ['house-of-wisdom'],
        icon:
          'https://data.aoe4world.com/images/technologies/economic-wing-1.png',
        effects: [
          {
            property: 'hitpoints',
            select: {
  ...
  },
  {
    ...
    civs: ['ab'],
    unique: true,
    displayClasses: ['Economic Technology'],
    classes: ['economic', 'technology'],
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/fertile-crescent-2.png',
    description: 'Reduce the cost of Economy buildings and Houses by 25%.',
    variations: [
      {
        ...
        effects: [
          {
            property: 'foodCost',
            select: {
              id: ['house', 'mill', 'lumber-camp', 'dock', 'mining-camp'],
            },
            effect: 'multiply',
            value: 0.75,
            type: 'passive',
  ...
  },
  {
    ...
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/fresh-foodstuffs-2.png',
    ...
    variations: [
      {
        ...
        producedBy: ['house-of-wisdom'],
        icon:
          'https://data.aoe4world.com/images/technologies/grand-bazaar-2.png',
        effects: [
          {
            property: 'unknown',
            select: {
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/improved-processing-4.png',
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/medical-centers-3.png',
    description: 'Keeps heal nearby units for +2 health every 1 second.',
    variations: [
      {
  ...
  },
  {
    ...
    description:
      'Constructs the Military Wing.\nSpawns the following units upon completion:\n• 2 Spearmen & 1 Archer (Feudal Age)\n• 2 Camel Riders (Castle Age)\n• 3 Handcannoneers (Imperial Age)\nThe following military technologies become available:\n• Boot Camp (Feudal Age)\n• Composite Bows (Castle Age)\n• Camel Support (Imperial Age)',
    variations: [
      {
        id: 'military-wing-1',
        ...
        producedBy: ['house-of-wisdom'],
        icon:
          'https://data.aoe4world.com/images/technologies/military-wing-1.png',
        effects: [
          {
            property: 'hitpoints',
            select: {
  ...
  },
  {
    ...
    civs: ['ab'],
    unique: true,
    displayClasses: ['Research Technology'],
    classes: ['research', 'technology'],
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/preservation-of-knowledge-2.png',
    description: 'Reduce the cost of all technology by -20%.',
    variations: [
      {
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/proselytization-4.png',
    description:
    ...
    variations: [
      {
        ...
        producedBy: ['house-of-wisdom'],
        icon:
          'https://data.aoe4world.com/images/technologies/spice-roads-4.png',
        effects: [
          {
            property: 'goldGatherRate',
            select: {
  ...
  },
  {
    ...
    classes: ['naval', 'technology'],
    minAge: 3,
    icon: 'https://data.aoe4world.com/images/technologies/teak-masts-3.png',
    description: 'Increase the move speed of military ships +10.',
    variations: [
      {
        id: 'teak-masts-3',
        baseId: 'teak-masts',
  ...
  },
  {
    ...
    description:
      'Constructs the Trade Wing.\nSpawns 3 Traders upon completion and acts as a Home Market.\nThe following trade technologies become available:\n• Grand Bazaar (Feudal Age)\n• Armored Caravans (Castle Age)\n• Spice Roads (Imperial Age)',
    variations: [
      {
        id: 'trade-wing-1',
        baseId: 'trade-wing',
  ...
  },
  {
    ...
    description: 'Buildings are repaired +100% faster.',
    variations: [
      {
        id: 'banco-repairs-2',
        ...
        producedBy: ['capital-town-center', 'town-center'],
        icon:
          'https://data.aoe4world.com/images/technologies/banco-repairs-2.png',
        effects: [],
      },
    ],
    shared: {},
    ...
    variations: [
      {
        ...
        producedBy: ['dock'],
        icon:
          'https://data.aoe4world.com/images/technologies/canoe-tactics-2.png',
        effects: [
          {
            property: 'rangedAttack',
            select: {
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/farima-leadership-4.png',
    ...
    variations: [
      {
        ...
        producedBy: ['stable'],
        icon:
          'https://data.aoe4world.com/images/technologies/imported-armor-3.png',
        effects: [
          {
            property: 'meleeArmor',
            select: {
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/local-knowledge-3.png',
        ...
        effects: [
          {
            property: 'healingRate',
            select: {
              id: ['musofadi-gunner', 'musofadi-warrior'],
            },
            effect: 'change',
            value: 2,
            type: 'passive',
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/poisoned-arrows-3.png',
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/precision-training-4.png',
    description:
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/acid-distillation-improved-3.png',
    description:
      "Increase Villagers' gathering rate for Gold by 22.5%.\nIf Acid Distillation has already been researched, increase it by 7.5% instead.",
    variations: [
      {
  ...
  },
  {
    ...
    civs: ['mo'],
    unique: true,
    displayClasses: ['Raiding Technology'],
    classes: ['raiding', 'technology'],
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/additional-torches-3.png',
    ...
    variations: [
      {
        ...
        producedBy: ['ovoo', 'the-white-stupa'],
        icon:
          'https://data.aoe4world.com/images/technologies/additional-torches-3.png',
        effects: [
          {
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/additional-torches-improved-3.png',
    description:
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/adjustable-crossbars-improved-4.png',
    description:
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/biology-improved-4.png',
    description:
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/crosscut-saw-improved-4.png',
    description:
      "Increase Villagers' gathering rate for Wood by 22.5%.\nIf Crosscut Saw has already been researched, increase it by 7.5% instead.",
    variations: [
      {
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/cupellation-improved-4.png',
    description:
  ...
  },
  {
    ...
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/double-broadax-improved-2.png',
    description:
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/elite-army-tactics-improved-4.png',
    description:
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/fertilization-improved-3.png',
    description:
      "Increase Villagers' gathering rate for Food by 22.5%. Does not apply to hunted meat.\nIf Fertilization has already been researched, increase it by 7.5% instead.",
    variations: [
      {
  ...
  },
  {
    ...
    minAge: 1,
    icon:
      'https://data.aoe4world.com/images/technologies/forestry-improved-1.png',
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/geometry-improved-4.png',
    description:
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/greased-axles-improved-3.png',
    description:
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/herbal-medicine-improved-3.png',
    description:
      'Increase the healing rate of religious units by +90%.\nIf Herbal Medicine has already been researched, increase it by +30% instead.',
    variations: [
      {
  ...
  },
  {
    ...
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/horticulture-improved-2.png',
    description:
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/lightweight-beams-improved-4.png',
    description:
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/lumber-preservation-improved-3.png',
    description:
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/monastic-shrines-4.png',
    description:
    ...
    variations: [
      {
        ...
        producedBy: ['prayer-tent'],
        icon:
          'https://data.aoe4world.com/images/technologies/piety-improved-4.png',
        effects: [
          {
            property: 'hitpoints',
            select: {
        ...
        effects: [
          {
            property: 'unknown',
            select: {
              id: ['light-junk', 'explosive-junk', 'war-junk', 'baochuan'],
            },
            effect: 'change',
            value: 25,
            type: 'ability',
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/precision-cross-breeding-improved-4.png',
    description:
  ...
  },
  {
    ...
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/professional-scouts-improved-2.png',
    description:
      'Scouts gain the ability to carry animal carcasses and +200% damage against wild animals.\nIf Professional Scouts has already been researched, increase ranged damage against wild animals by +100% instead.\nScouts move -35% slower while carrying and cannot pick up Boar.',
    variations: [
      {
    ...
    variations: [
      {
        ...
        producedBy: ['ovoo', 'the-white-stupa'],
        icon:
          'https://data.aoe4world.com/images/technologies/raid-bounty-2.png',
        effects: [
          {
            property: 'unknown',
            select: {
  ...
  },
  {
    ...
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/raid-bounty-improved-2.png',
    description:
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/roller-shutter-triggers-improved-4.png',
    description:
      'Increase the weapon range of Springalds by +3 tiles and reduce their reload time by 35%.\nIf Roller Shutter Triggers has already been researched, increase their weapon range by +1 tiles and reduce reload time by 10% instead.',
    variations: [
      {
  ...
  },
  {
    ...
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/siege-engineering-improved-2.png',
    description:
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/siege-works-improved-4.png',
    description:
      'Increase the health of siege engines by +30% and their ranged armor by +15.\nIf Siege Works has already been researched, increase their health by +10% and ranged armor by +5 instead.',
    variations: [
      {
  ...
  },
  {
    ...
    civs: ['mo'],
    unique: true,
    displayClasses: ['Ranged Damage Technology'],
    classes: ['ranged', 'damage', 'technology'],
    minAge: 4,
    ...
    variations: [
      {
        ...
        producedBy: ['archery-range'],
        icon:
          'https://data.aoe4world.com/images/technologies/siha-bow-limbs-4.png',
        effects: [
          {
            property: 'rangedAttack',
            select: {
              id: ['khan', 'mangudai', 'khaganate-elite-mangudai'],
            },
            effect: 'change',
            value: 1,
            type: 'passive',
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/siha-bow-limbs-improved-4.png',
    description:
      'Increase the ranged damage of Mangudai and the Khan by +2.\nIf Siha Bow Limbs has already been researched, increase the ranged damage of Mangudai and the Khan by +1.',
    variations: [
      {
  ...
  },
  {
    ...
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/specialized-pick-improved-2.png',
    description:
    ...
    variations: [
      {
        ...
        producedBy: ['ovoo', 'the-white-stupa'],
        icon:
          'https://data.aoe4world.com/images/technologies/stone-bounty-4.png',
        effects: [
          {
            property: 'unknown',
            select: {
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/stone-bounty-improved-4.png',
    description:
  ...
  },
  {
    ...
    description:
      'Having 9 or more active Traders causes them to supply +10% Stone to their trades.',
    variations: [
      {
        id: 'stone-commerce-4',
        ...
        producedBy: ['the-silver-tree', 'market'],
        icon:
          'https://data.aoe4world.com/images/technologies/stone-commerce-4.png',
        effects: [
          {
            property: 'unknown',
            select: {
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/stone-commerce-improved-4.png',
    description:
      'Having 9 or more active Traders causes them to supply +20% Stone to their trades.\nIf Stone Commerce has already been researched, supply +10% Stone instead.',
    variations: [
      {
  ...
  },
  {
    ...
    civs: ['mo'],
    unique: true,
    displayClasses: ['Packing Technology'],
    classes: ['packing', 'technology'],
    minAge: 1,
    icon:
      'https://data.aoe4world.com/images/upgrades/packed-buildings-move-and-pack-unpack-50-faster-1.png',
  ...
  },
  {
    ...
    minAge: 1,
    icon:
      'https://data.aoe4world.com/images/technologies/survival-techniques-improved-1.png',
    description:
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/textiles-improved-3.png',
    description:
      "Increase Villagers' health by +50.\nIf Textiles has already been researched, increase health by +25 instead.",
    variations: [
      {
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/tithe-barns-improved-4.png',
    description:
      'Relics placed in a Prayer Tent provide an income of +45 Food, +45 Wood, and +45 Stone every minute.\nIf Tithe Barns has already been researched, increase the income of Food, Wood, and Stone by +15 instead.',
    variations: [
      {
  ...
  },
  {
    ...
    minAge: 1,
    icon:
      'https://data.aoe4world.com/images/technologies/wheelbarrow-improved-1.png',
    description:
  ...
  },
  {
    ...
    civs: ['mo'],
    unique: true,
    displayClasses: ['Khan Technology'],
    classes: ['khan', 'technology'],
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/whistling-arrows-2.png',
    description:
  ...
  },
  {
    ...
    minAge: 2,
    icon:
      'https://data.aoe4world.com/images/technologies/whistling-arrows-improved-2.png',
    description:
  ...
  },
  {
    ...
    civs: ['mo'],
    unique: true,
    displayClasses: ['Movement Technology'],
    classes: ['movement', 'technology'],
    minAge: 3,
    ...
    variations: [
      {
        ...
        producedBy: ['outpost'],
        icon:
          'https://data.aoe4world.com/images/technologies/yam-network-3.png',
        effects: [
          {
            property: 'unknown',
            select: {
              class: [['infantry'], ['siege']],
            },
            effect: 'change',
            value: 1,
            type: 'influence',
  ...
  },
  {
    ...
    civs: ['ot'],
    unique: true,
    displayClasses: ['Imperial Council'],
    classes: ['imperial', 'council'],
    minAge: 1,
    icon:
      'https://data.aoe4world.com/images/technologies/advanced-academy-1.png',
    description:
  ...
  },
  {
    ...
    minAge: 1,
    icon:
      'https://data.aoe4world.com/images/technologies/anatolian-hills-1.png',
    description:
    ...
    variations: [
      {
        ...
        producedBy: [],
        icon:
          'https://data.aoe4world.com/images/technologies/fast-training-1.png',
        effects: [
          {
            property: 'productionSpeed',
            select: {
    ...
    variations: [
      {
        ...
        producedBy: ['dock'],
        icon:
          'https://data.aoe4world.com/images/technologies/imperial-fleet-4.png',
        effects: [
          {
            property: 'productionSpeed',
            select: {
              id: ['carrack', 'grand-galley'],
            },
            effect: 'multiply',
            value: 0.8,
            type: 'passive',
  ...
  },
  {
    ...
    minAge: 1,
    icon:
      'https://data.aoe4world.com/images/technologies/janissary-company-1.png',
    description:
  ...
  },
  {
    ...
    civs: ['ot'],
    unique: true,
    displayClasses: ['Janissary Technology'],
    classes: ['janissary', 'technology'],
    minAge: 4,
    ...
    variations: [
      {
        ...
        producedBy: ['archery-range'],
        icon:
          'https://data.aoe4world.com/images/technologies/janissary-guns-4.png',
        effects: [
          {
            property: 'rangedAttack',
            select: {
    ...
    variations: [
      {
        ...
        producedBy: [],
        icon:
          'https://data.aoe4world.com/images/technologies/mehter-drums-1.png',
        effects: [
          {
            property: 'moveSpeed',
            select: {
  ...
  },
  {
    ...
    minAge: 1,
    icon:
      'https://data.aoe4world.com/images/technologies/military-campus-1.png',
    ...
    variations: [
      {
        ...
        producedBy: [],
        icon:
          'https://data.aoe4world.com/images/technologies/siege-crews-1.png',
        effects: [],
      },
    ],
    shared: {},
  },
  {
    ...
    description: 'Increase the amount of Gold Traders collect by +40%.',
    variations: [
      {
        id: 'trade-bags-1',
        baseId: 'trade-bags',
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/adaptable-hulls-3.png',
    description:
    ...
    variations: [
      {
        ...
        producedBy: ['high-armory'],
        icon:
          'https://data.aoe4world.com/images/technologies/banded-arms-4.png',
        effects: [
          {
            property: 'maxRange',
            select: {
  ...
  },
  {
    ...
    minAge: 3,
    icon:
      'https://data.aoe4world.com/images/technologies/boyars-fortitude-3.png',
    description: 'Increase the health of Rus cavalry by +30.',
    variations: [
      {
    ...
    variations: [
      {
        ...
        producedBy: ['wooden-fortress'],
        icon:
          'https://data.aoe4world.com/images/technologies/castle-turret-1.png',
        effects: [
          {
            property: 'rangedAttack',
            select: {
  ...
  },
  {
    ...
    civs: ['ru'],
    unique: true,
    displayClasses: ['Vision Emplacement'],
    classes: ['vision', 'emplacement'],
    minAge: 2,
    ...
    variations: [
      {
        ...
        producedBy: ['wooden-fortress'],
        icon:
          'https://data.aoe4world.com/images/technologies/castle-watch-1.png',
        effects: [
          {
            property: 'lineOfSight',
            select: {
    ...
    variations: [
      {
        ...
        producedBy: ['abbey-of-the-trinity', 'monastery'],
        icon:
          'https://data.aoe4world.com/images/technologies/divine-light-1.png',
        effects: [
          {
            property: 'unknown',
            select: {
  ...
  },
  {
    ...
    civs: ['ru'],
    unique: true,
    displayClasses: ['Streltsy Ability Unlock'],
    classes: ['streltsy', 'ability', 'unlock'],
    minAge: 4,
    icon: 'https://data.aoe4world.com/images/technologies/double-time-4.png',
    description:
    ...
    variations: [
      {
        ...
        name: 'Double Time',
        pbgid: 207443,
        attribName: 'upgrade_streltsy_double_time_rus',
        age: 4,
        civs: ['ru'],
        description:
          'Streltsy gain the Double Time ability, which increases their movement speed by +30% for 10 seconds.',
        ...
        producedBy: ['archery-range'],
        icon:
          'https://data.aoe4world.com/images/technologies/double-time-4.png',
        effects: [
          {
            property: 'moveSpeed',
            select: {
    ...
    variations: [
      {
        ...
        producedBy: ['abbey-of-the-trinity'],
        icon: 'https://data.aoe4world.com/images/technologies/fervor-3.png',
        effects: [
          {
            property: 'unknown',
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/fine-tuned-guns-4.png',
    description:
  ...
  },
  {
    ...
    civs: ['ru'],
    unique: true,
    displayClasses: ['Knight Technology'],
    classes: ['knight', 'technology'],
    minAge: 4,
    icon: 'https://data.aoe4world.com/images/technologies/knight-sabers-4.png',
    description: 'Increase the sword damage of Knights by +4.',
    variations: [
      {
        id: 'knight-sabers-4',
        baseId: 'knight-sabers',
        type: 'technology',
        name: 'Knight Sabers',
        pbgid: 207441,
        ...
        producedBy: ['stable'],
        icon:
          'https://data.aoe4world.com/images/technologies/knight-sabers-4.png',
        effects: [
          {
            property: 'meleeAttack',
            select: {
  ...
  {
    id: 'mounted-precision',
    name: 'Mounted Precision',
    type: 'technology',
    civs: ['ru'],
    unique: true,
    displayClasses: ['Horse Archer Technology'],
    classes: ['horse', 'archer', 'technology'],
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/mounted-precision-4.png',
    description: 'Increase the weapon range of Horse Archers by +1.',
    variations: [
      {
        id: 'mounted-precision-4',
        baseId: 'mounted-precision',
        type: 'technology',
        name: 'Mounted Precision',
        pbgid: 207445,
        attribName: 'upgrade_streltsy_weapon_percision_rus',
        age: 4,
        civs: ['ru'],
        description: 'Increase the weapon range of Horse Archers by +1.',
        classes: ['horse', 'archer', 'technology'],
  ...
  },
  {
    ...
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/saints-veneration-4.png',
  ...
  },
  {
    ...
    civs: ['ru'],
    unique: true,
    displayClasses: ['Mangonel', 'Trebuchet', 'and Bombard Technology'],
    classes: ['mangonel', 'trebuchet', 'and', 'bombard', 'technology'],
    minAge: 4,
    icon:
      'https://data.aoe4world.com/images/technologies/siege-crew-training-4.png',
    description:
        ...
        effects: [
          {
            property: 'attackSpeed',
            select: {
              id: ['counterweight-trebuchet', 'mangonel', 'bombard'],
            },
            effect: 'change',
            value: 0,
            type: 'passive',
  ...
  },
  {
    ...
    civs: ['ru'],
    unique: true,
    displayClasses: ['Ram Technology'],
    classes: ['ram', 'technology'],
    minAge: 4,
    ...
    variations: [
      {
        ...
        producedBy: ['high-armory'],
        icon:
          'https://data.aoe4world.com/images/technologies/wandering-town-4.png',
        effects: [
          {
            property: 'siegeAttack',
            select: {
